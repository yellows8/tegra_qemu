...
static uint32_t tegra_car_regdef_tegrax1_reset_table[] = {
    ...
    TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_RST_DEVICES_L_0, 0x4, 0x1CD3D000)
    TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_RST_DEVICES_H_0, 0x8, 0x87D1F320)
    ...
    TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_PLLU_BASE_0, 0xC0, 0x00011902)
    ...
    //TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_RST_DEV_L_SET_0, 0x300, 0x1CD3D000)
    //TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_RST_DEV_L_CLR_0, 0x304, 0x1CD3D000)
    //TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_RST_DEV_H_SET_0, 0x308, 0x87D1F320)
    ...
    TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_RST_CPU_CMPLX_SET_0, 0x340, 0x2000000F)
    ...
    TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_CLK_SOURCE_ISPB_0, 0x404, 0xC0000000)
    ...
    TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_RST_CPUG_CMPLX_SET_0, 0x450, 0x2000000F)
    ...
    TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_UTMIP_PLL_CFG2_0, 0x488, 0x00318015)
    TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_PLLE_AUX_0, 0x48C, 0x06002070)
    TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_SATA_PLL_CFG0_0, 0x490, 0x00003803)
    TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_SATA_PLL_CFG1_0, 0x494, 0x00011400)
    TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_PCIE_PLL_CFG_0, 0x498, 0x0600000C)
    ...
    TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_XUSBIO_PLL_CFG0_0, 0x51C, 0x0600380D)
    ...
    TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_UTMIPLL_HW_PWRDN_CFG0_0, 0x52C, 0x0600000F)
    TEGRA_REGDEF_TABLE_RESET(CLK_RST_CONTROLLER_PLLU_HW_PWRDN_CFG0_0, 0x530, 0x0600008D)
